...
This file provides context and guidelines for Claude Code when working in this comparative genomics repository.

## Project Overview

This is a comparative genomics analysis project that uses various bioinformatics tools including OrthoFinder, Jupyter notebooks, and Python analysis scripts.
...
When making code changes, ensure code quality by running:
```bash
# For Python code formatting (if Black is available)
black .
# For shell script checking (if shellcheck is available)
...
- Analysis notebooks and Python scripts for comparative genomics workflows